                ...
                <div class="col-md-4 grid-margin">
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <h4 class="mb-1">{{ $kepalaSekolah->nama_lengkap ?? Auth::user()->name }}</h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="profileTabsContent">
                                ...
                                <div class="tab-pane fade show active" id="overview" role="tabpanel">
                                    <h5 class="mb-3">Informasi Kepala Sekolah</h5>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label">Nama Lengkap</label>
                                                <p class="form-control-static">{{ $kepalaSekolah->nama_lengkap ?? '-' }}</p>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label">NIP</label>
                                                <p class="form-control-static">{{ $kepalaSekolah->nip ?? '-' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <p class="form-control-static">{{ $kepalaSekolah->jabatan ?? '-' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <p class="form-control-static">{{ $kepalaSekolah->alamat ?? '-' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="tab-pane fade" id="edit" role="tabpanel">
                                    ...
                                    <form id="profileForm" action="{{ route('kepalasekolah.profile.update') }}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="nama_lengkap"
                                                        name="nama_lengkap"
                                                        value="{{ old('nama_lengkap', $kepalaSekolah->nama_lengkap ?? '') }}"
                                                        required>
                                                    @error('nama_lengkap')
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control nip-readonly"
                                                        id="nip" name="nip"
                                                        value="{{ old('nip', $kepalaSekolah->nip ?? '') }}" readonly>
                                                    <small class="form-text text-muted">
                                                        <i class="mdi mdi-information-outline mr-1"></i>
                                                        NIP tidak dapat diubah. Hubungi admin jika perlu perubahan.
                                                    </small>
                                                    @error('nip')
                                                        <div class="text-danger small">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="jenis_kelamin" name="jenis_kelamin"
                                                        ...
                                                        <option value="Laki-laki"
                                                            {{ old('jenis_kelamin', $kepalaSekolah->jenis_kelamin ?? '') == 'Laki-laki' ? 'selected' : '' }}>
                                                            Laki-laki</option>
                                                        <option value="Perempuan"
                                                            {{ old('jenis_kelamin', $kepalaSekolah->jenis_kelamin ?? '') == 'Perempuan' ? 'selected' : '' }}>
                                                            Perempuan</option>
                                                    </select>
                                                    @error('jenis_kelamin')
                                                        <div class="text-danger small">{{ $message }}</div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control nip-readonly"
                                                        ...
                                                        value="{{ old('jabatan', $kepalaSekolah->jabatan ?? 'Kepala Sekolah') }}"
                                                        readonly>
                                                    <small class="form-text text-muted">
                                                        <i class="mdi mdi-information-outline mr-1"></i>
                                                        Jabatan tidak dapat diubah. Hubungi admin jika perlu perubahan.
                                                    </small>
                                                    @error('jabatan')
                                                        <div class="text-danger small">{{ $message }}</div>
                                                    @enderror
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="alamat" name="alamat" rows="3" placeholder="Masukkan alamat lengkap">{{ old('alamat', $kepalaSekolah->alamat ?? '') }}</textarea>
                                                    @error('alamat')
                                                        <div class="text-danger small">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                ...
                                <div class="tab-pane fade" id="password" role="tabpanel">
                                    ...
                                    <form id="passwordForm" action="{{ route('kepalasekolah.password.update') }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
