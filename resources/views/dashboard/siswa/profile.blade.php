                            ...
                            <div class="tab-content" id="profileTabContent">
                                ...
                                <div class="tab-pane fade show active" id="overview" role="tabpanel">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-8 text-primary" data-field="tempat_lahir">
                                            {{ $student->tempat_lahir }}</div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-md-4 text-muted">Tanggal Lahir</div>
                                        <div class="col-md-8 text-primary" data-field="tanggal_lahir">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-8 text-primary" data-field="jenis_kelamin">
                                            {{ $student->jenis_kelamin }}</div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-md-4 text-muted">Alamat</div>
                                        <div class="col-md-8 text-primary" data-field="alamat">
                                            {{ $student->alamat ?? 'Kendayakan, Kec. Terisi, Kabupaten Indramayu, Jawa Barat 45262' }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-8 text-primary" data-field="no_telp">
                                            {{ $student->user->no_telp ?? '+628277XXX' }}</div>
                                    </div>

                                    <div class="row mb-2">
                                        <div class="col-md-4 text-muted">Email</div>
                                        <div class="col-md-8 text-primary" data-field="email">
                                            {{ $student->user->email ?? 'Student@smk1terisi.sch.id' }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="edit" role="tabpanel">
                                    <form id="editProfileForm" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label for="nisn"
                                                class="col-md-3 col-form-label text-md-right">NISN</label>
                                            <div class="col-md-9">
                                        ...
                                        <!-- Tempat Lahir -->
                                        <div class="form-group row mb-3">
                                            <label for="tempat_lahir" class="col-md-3 col-form-label text-md-right">Tempat
                                                Lahir</label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label for="tanggal_lahir"
                                                class="col-md-3 col-form-label text-md-right">Tanggal Lahir</label>
                                            <div class="col-md-9">
                                        ...
                                        <div class="form-group row mb-0">
                                            <div class="col-md-9 offset-md-3">
                                                <button type="submit" id="profileUpdateBtn" class="btn btn-primary">Save
                                                    Changes</button>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="tab-pane fade" id="password" role="tabpanel">
                                    ...
                                    <form id="changePasswordForm">
                                        ...
                                        <div class="text-end mt-4">
                                            <button type="submit" id="passwordUpdateBtn" class="btn btn-primary">Change
                                                Password</button>
                                        </div>
                                    </form>
                                </div>
