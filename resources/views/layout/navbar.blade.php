...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="{{ route('dashboard') }}">
            <img src="{{ $mainLogo }}" class="mr-2" alt="{{ $logoAlt }}"
                style="height: auto; max-height: 40px; width: auto; object-fit: contain;" />
        </a>
        <a class="navbar-brand brand-logo-mini" href="{{ route('dashboard') }}">
            <img src="{{ $miniLogo }}" alt="{{ $logoAlt }}"
                style="height: auto; max-height: 30px; width: auto; object-fit: contain;" />
        </a>
    </div>
