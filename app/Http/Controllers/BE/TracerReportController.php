...
class TracerReportController extends Controller
{
    ...
    private function generatePdfReport($reportType, $students, $reportData)
    {
        ...
        return $pdf->download('tracer-study-report-' . $reportType . '.pdf');
    }
    ...
    private function generateExcelReport($reportType, $students, $reportData)
    {
        return Excel::download(
            ...
            'tracer-study-report-' . $reportType . '.xlsx'
        );
    }
    ...
    public function exportRawData(Request $request)
    {
        ...
        if ($format === 'excel') {
            return Excel::download(new TracerStudyExport('raw'), 'tracer-study-raw-data.xlsx');
        } else {
            ...
            return $pdf->download('tracer-study-raw-data.pdf');
        }
    }
